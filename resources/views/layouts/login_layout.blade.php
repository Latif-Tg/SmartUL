		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
                    ...
                    <span>Vous disposez d'un compte <span style="color:rgb(0,100,10);">@yield('type')</span></span>
				</div>
                <form method="POST" action="@yield('login_route')" class="login100-form validate-form">
                    @csrf
